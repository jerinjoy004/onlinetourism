					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="manage-agencies.php"><i class="fa fa-users" aria-hidden="true"></i><span>Manage Agencies</span><div class="clearfix"></div></a></li>
									<li><a href="manage-itinerary.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Itineraries</span><div class="clearfix"></div></a></li>
