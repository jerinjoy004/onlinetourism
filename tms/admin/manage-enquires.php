...
<html>
<head>
<title>Horizon | Admin manage Bookings</title>
...
<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Have you read')" >Pending</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
